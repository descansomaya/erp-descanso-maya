...
App.logic = {
    ...
    async eliminarPedido(id) { 
        ...
        // Devolución automática de hilos
            ...
            try {
                ...
                for(let item of receta) {
                    ...
                    if(material && parseFloat(item.cant) > 0) {
                        ...
                        material.stock_actual = nStock; // Update local state
        ...
        // Eliminación en cascada en un solo lote
